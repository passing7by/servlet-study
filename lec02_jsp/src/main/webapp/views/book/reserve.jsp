...
<head>
<meta charset="UTF-8">
<title>도서 대출 화면</title>
</head>
<body>
	<h2>도서 대출</h2>
	<form action="/bookReserveEnd" method="get">
		<fieldset>
			<legend>고객 정보</legend>
			<label for="user_name">고객명 : </label>
			<input type="text" id="user_name" name="userName"><br>
			<label for="user_phone">전화번호 : </label>
			<input type="text" id="user_phone" name="userPhone"><br>
		...
		<fieldset>
			...
			<select id="book_name" name="bookName">
		...
		<fieldset>
			...
			<input type="number" id="borrow_period" min="1" max="30" step="1" name="borrowPeriod">
		</fieldset>
